...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    {
        weaponNameText.text = string.Format("({0}) {1}", weapon.weaponListPosition, weapon.weaponDetails.weaponName.ToUpper());
    }
    ...
    private void UpdateAmmoText(Weapon weapon)
    {
        ...
        {
            ammoRemainingText.text = string.Format("{0} / {1}", weapon.weaponRemainingAmmo.ToString(), weapon.weaponDetails.weaponAmmoCapacity.ToString());
        }
    }
